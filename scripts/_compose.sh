...
# In-container SSL client config (written by the broker entrypoint in ssl/dual mode).
SSL_CLIENT_CONFIG_IN_CONTAINER="/etc/kafka/secrets/healthcheck.properties"
